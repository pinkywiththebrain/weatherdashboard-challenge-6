  ...
  //Fetch to retrieve today's weather in the searched location
    .then(function() {
      ...
      .then(function(data) {
        ...
        document.querySelector('#currentIcon').src =  'http://openweathermap.org/img/wn/' + data.weather[0].icon + '@2x.png';
  ...
  //Fetch to retrieve the 5-day weather information
    .then(function() {
      ...
      .then(function(data) {
        ...
        document.querySelector('#icon2').src = 'http://openweathermap.org/img/wn/' + data.list[1].weather[0].icon + '@2x.png';
        ...
        document.querySelector('#icon3').src = 'http://openweathermap.org/img/wn/' + data.list[2].weather[0].icon + '@2x.png';
        ...
        document.querySelector('#icon4').src = 'http://openweathermap.org/img/wn/' + data.list[3].weather[0].icon + '@2x.png';
        ...
        document.querySelector('#icon5').src = 'http://openweathermap.org/img/wn/' + data.list[4].weather[0].icon + '@2x.png';
